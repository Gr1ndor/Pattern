...
{
    Command* pCom;
    pCom = new DeleteDynamic(pObj, vecDynamicObj);
    pCom->Execute();
    delete pCom;
}
...
{
    Command* pCom;
    pCom = new DeleteStatic(pObj, vecStaticObj);
    pCom->Execute();
    delete pCom;
}
...
{
    Command* pCom;
    pCom = new DropBombs(FindPlane(), vecDynamicObj, &bombsNumber, &score);
    pCom->Execute();
    delete pCom;
}

void DeleteDynamic::Execute()
{
    auto it = v.begin();
    for (; it != v.end(); it++)
    {
