...
namespace MyTools {
    ...
    //=============================================================================================
    void __fastcall LoggerSingletone::OpenLogFile(const std::string& FN) { fileLog->OpenLogFile(FN); };
    void LoggerSingletone::CloseLogFile() { fileLog->CloseLogFile(); };
    void __fastcall LoggerSingletone::WriteToLog(const std::string& str) { logOut << numLog++ << ":  "; fileLog->WriteToLog(str); };
    void __fastcall LoggerSingletone::WriteToLog(const std::string& str, int n) { logOut << numLog++ << ":  "; fileLog->WriteToLog(str, n); };
    void __fastcall LoggerSingletone::WriteToLog(const std::string& str, double d) { logOut << numLog++ << ":  "; fileLog->WriteToLog(str, d); };
